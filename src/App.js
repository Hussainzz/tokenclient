...
class App extends Component {
  state = { loaded: false, kycAddress:'0x1212...', tokenSaleAddress: null, userTokens:0, totalSupply:0};
  ...
  updateUserTokens = async () => {
    ...
    this.setState({userTokens: userTokens, totalSupply: tokenSupply});
  }

  listenToMint = () => {
    this.tokenInstance.events.Transfer({}).on("data",this.updateTokens);
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Buy Tokens</h2>
        <p>To buy tokens send wei on this address {this.state.tokenSaleAddress}</p>
        <h3>TOTAL SUPPLY : {this.state.totalSupply}</h3>
        <p>You currently have: {this.state.userTokens} ARFZ Token</p>
